...
function UtilityPage({ mode }: { mode: Exclude<Mode, "label-designer" | "packaging" | "returns" | "settings" | "products"> }) {
  const titles: Record<typeof mode, string> = { "label-print": "چاپ لیبل", reports: "گزارش‌ها" };
