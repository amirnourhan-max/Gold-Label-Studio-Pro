...
type Mode = "label-print" | "label-designer" | "packaging" | "returns" | "products" | "reports" | "settings";
...
function UtilityPage({ mode }: { mode: Exclude<Mode, "label-designer" | "packaging" | "returns" | "settings"> }) {
  const titles: Record<typeof mode, string> = { "label-print": "چاپ لیبل", products: "محصولات", reports: "گزارش‌ها" };
